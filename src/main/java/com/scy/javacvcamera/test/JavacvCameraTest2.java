 ...
 * 保存到文件
 */
public class JavacvCameraTest2 {

    public static void main(String[] args) throws Exception, InterruptedException, org.bytedeco.javacv.FrameRecorder.Exception {
        //recordCamera("rtmp://www.ossrs.net:1935/live/demo12036",25);
        String filePath = "output.mp4";
        recordCamera(filePath, 25);
    }
    ...
    public static void recordCamera(String outputFile, double frameRate)
        ...
        FrameRecorder recorder = FrameRecorder.createDefault(outputFile, width,
                height);
